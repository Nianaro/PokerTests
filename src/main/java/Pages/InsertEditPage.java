...
public class InsertEditPage extends Page {
    ...
    public void editPlayer(PokerPlayer player) {
        webDriver.findElement(By.xpath(FIRST_NAME_INPUT_XPATH_INSERT_EDIT_PAGE)).clear();
        webDriver.findElement(By.xpath(FIRST_NAME_INPUT_XPATH_INSERT_EDIT_PAGE)).sendKeys(player.getFirstName());

        webDriver.findElement(By.xpath(LAST_NAME_INPUT_XPATH_INSERT_EDIT_PAGE)).clear();
        webDriver.findElement(By.xpath(LAST_NAME_INPUT_XPATH_INSERT_EDIT_PAGE)).sendKeys(player.getLastName());

        webDriver.findElement(By.xpath(CITY_INPUT_XPATH_INSERT_EDIT_PAGE)).clear();
        ...
        webDriver.findElement(By.xpath(ADDRESS_TEXTAREA_XPATH_INSERT_EDIT_PAGE)).clear();
        webDriver.findElement(By.xpath(ADDRESS_TEXTAREA_XPATH_INSERT_EDIT_PAGE)).sendKeys(player.getAddress());


        webDriver.findElement(By.xpath(PHONE_INPUT_XPATH_INSERT_EDIT_PAGE)).clear();
    ...
    public void addPlayer(PokerPlayer player) {
        webDriver.findElement(By.xpath(USER_NAME_INPUT_XPATH_INSERT_EDIT_PAGE)).sendKeys(player.getUserName());
